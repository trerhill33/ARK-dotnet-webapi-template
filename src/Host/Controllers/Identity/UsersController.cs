...
using ARK.WebApi.Application.Identity.Users.Password;

namespace ARK.WebApi.Host.Controllers.Identity;
...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(ARKAction.View, ARKResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(ARKAction.View, ARKResource.UserRoles)]
    ...
    [MustHavePermission(ARKAction.Update, ARKResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(ARKAction.Create, ARKResource.Users)]
    ...
    [MustHavePermission(ARKAction.Update, ARKResource.Users)]
    [ApiConventionMethod(typeof(ARKApiConventions), nameof(ARKApiConventions.Register))]
