...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(ARKAction.View, ARKResource.Roles)]
    ...
    [MustHavePermission(ARKAction.View, ARKResource.RoleClaims)]
    ...
    [MustHavePermission(ARKAction.Update, ARKResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(ARKAction.Create, ARKResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(ARKAction.Delete, ARKResource.Roles)]
